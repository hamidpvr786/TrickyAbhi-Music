...
async def play(c: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(
                  [[
                      ...
                      InlineKeyboardButton("• Cʜᴀɴɴᴇʟ", url=f"https://t.me/hubburasoolsongs"),
                      InlineKeyboardButton("• Group", url=f"https://t.me/islamicsongsmadhsongs"),
                  ],[
    ...
    if replied:
        ...
        if len(m.command) < 2:
         await m.reply_photo(
                    ...
                    [
                        [
                            InlineKeyboardButton("~ Channel ~", url=f"https://t.me/hubburasoolsongs"),
                            InlineKeyboardButton("~ Support ~", url=f"https://t.me/islamicsongsmadhsongs")
                        ],
                        [
                            InlineKeyboardButton("🗑 Close", callback_data="cls")
                        ]
